...
export default function SettingsPage() {
  ...
  // Deep-link support: /dashboard/settings?tab=segments opens that tab.
  useEffect(() => {
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-sm text-[var(--dark-brown)]">{access ? planLabel : '…'}</span>
                  ...
                  {access?.trial_active && access?.trial_ends_at && (
                    <p className="text-xs text-[var(--walnut)] mt-1.5">
                      Trial access until {new Date(access.trial_ends_at).toLocaleDateString('en-IN', { day: 'numeric', month: 'short', year: 'numeric' })}.
                    </p>
                  )}
                </div>
                <div>
    ...
    <div className="glass-card p-4 sm:p-6 space-y-4">
      ...
      <div className="pt-4 border-t border-[rgba(221,184,146,0.35)] mt-6">
        <p className="text-xs text-[var(--walnut)]">
          ...
          {' '}: it reflects here within a minute. Not connected yet? Contact the PraecisAI team to link your account.
        </p>
      </div>
    </div>
  );
